...
app.use(
  cors({
    origin: ["https://jorge2echemendia.github.io", "http://localhost:3000"],
  }),
);

app.get("/", (req, res) => {
  res.send("KeyForge API funcionando correctamente 🚀");
});
...
const productos = [
  {
    ...
    descripcion:
      "Teclado 60% con switches Cherry MX Red y chasis de aluminio CNC.",
    precio: 129.99,
    imagen:
  ...
  },
  {
    ...
    descripcion:
      "Diseño ergonómico dividido, switches silenciosos y keycaps PBT.",
    precio: 189.5,
    imagen:
  ...
  },
  {
    ...
    descripcion:
      "Full-size con iluminación RGB por tecla y reposamuñecas magnético.",
    precio: 199.99,
